...
'''
Note On Transmit* Functions:
HttpRequest.get_expiry_date() 
Returns timedelta object if that is the time it was set (or datetime)
(see venv/lib/python2.7/site-packages/django/contrib/sessions/backends/base.py)
'''
